...
class ResulArimeticas extends StatelessWidget {
  final converterctrl = Get.find<ArimeticCtr>();

  ResulArimeticas({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Obx(() => Expanded(
          child: NumberToChangeBase(text: '${converterctrl.res}'),
        ));
  }
}
